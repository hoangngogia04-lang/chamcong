    ...
    for (let d = 1; d <= daysInMonth; d++) {
      ...
      if (!isPartTime) {
        ...
        if (rec.start === 'OFF') {
          ...
          // Full-Time Row 3: Ngày làm (1 nếu đi làm, empty nếu không đi làm)
 ...
 * Supports Full-Time Row 3 displaying working days (1 / OFF)
